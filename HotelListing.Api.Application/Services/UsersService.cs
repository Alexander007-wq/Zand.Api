...
public class UsersService(UserManager<ApplicationUser> userManager, IOptions<JwtSettings> jwtOptions, IHttpContextAccessor httpContextAccessor, HotelListingDbContext hotelListingDbContext, ILogger<UsersService> logger) : IUsersService
{
